(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["y-my-utils"] = factory();
	else
		root["y-my-utils"] = factory();
})(globalThis, function() {
...
;// CONCATENATED MODULE: ./src/calcFn.js
...
/* harmony default export */ const src_calcFn = (calcFn);
;// CONCATENATED MODULE: ./src/y-my-utils.js
 ...
 * @returns {Object}
 */
var readEnv = function readEnv(data) {
  // let data = fs.readFileSync(fileName, { encoding: 'utf8' })
  var d = data.replace(/\r/g, ',').replace(/\n/g, ''); // 把换行和回车替换

  var arr = d.split(',').map(function (item) {
    return item.split('=');
  }); // [ [ 'a', '1' ], [ 'b', '2' ] ]
...
var replaceCurrentUrl = function replaceCurrentUrl(data, global) {
  var url = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  if (!data) return;
  var $window = global || window;
  var urlObj = getQueryObject(url) || {};

  var newUrlObj = _objectSpread(_objectSpread({}, urlObj), data);

  var _href = $window.location.href.split("?")[0];
  Object.keys(newUrlObj).forEach(function (item, index) {
    var keyValue = "".concat(item, "=").concat(newUrlObj[item]);
...
var idCardMask = function idCardMask() {
...
var scrollSpecifiedLoc = function scrollSpecifiedLoc() {
...
var multArray = function multArray(arr) {
...
/* harmony default export */ const y_my_utils = ({
  readEnv: readEnv,
  getQueryObject: getQueryObject,
  replaceCurrentUrl: replaceCurrentUrl,
  idCardMask: idCardMask,
  scrollSpecifiedLoc: scrollSpecifiedLoc,
  multArray: multArray,
  flatten: flatten,
